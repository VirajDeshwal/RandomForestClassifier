...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  7 23:11:36 2018
...
#we need to do the feature scaling in the Random Forest Classifer to get the accurate prediction.
...
#Call the model library. In this case we will call Random Forest  Classifier.
...
print ('\n\n Lets Visualize the results from Training set of the Random Forest Classifier\n\n')
...
print ('\n\n Lets Visualize the results from Testing set of the Random Forest  Classifier\n\n')
from matplotlib.colors import ListedColormap
...
print('\n\n\n Hence the accuracy of the Random ForestClassifier is:',accuracy)
print('\n\n Done :)')
